...
<jsp:include page="includes/header.jsp">
    <jsp:param name="title" value="Mentor Form"/>
</jsp:include>
<body>
...
<div class="container">
    ...
    <div class="mx-5">
        <h1 class="text-center">Mentor Intake Form</h1>
        <form action="mentor_form" method="post" onsubmit="return valChecked(this)">
                ...
                <!-- Ethnicity -->
                    <div class="form-row">
                        <div class="col">
                            ...
                            <div class="form-check">
                                <input class="validate-one-required" name="ethnicity" type="checkbox" id="defaultCheck1" value="White">
                                <label class="form-check-label" for="defaultCheck1"> White </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck2" value="Black/African Am.">
                                <label class="form-check-label" for="defaultCheck2"> Black/African American </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck3" value="Hispanic">
                                <label class="form-check-label" for="defaultCheck3"> Hispanic </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck4" value="Latinx">
                                <label class="form-check-label" for="defaultCheck1"> Latino/Latina </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck5" value="Native American">
                                <label class="form-check-label" for="defaultCheck5"> Native American/American Indian </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck6" value="Asian">
                                <label class="form-check-label" for="defaultCheck6"> Asian </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck7" value="Pacific Islander">
                                <label class="form-check-label" for="defaultCheck7"> Pacific Islander </label></div>
                            <div class="form-check">
                                <input class="required_group" name="ethnicity" type="checkbox" id="defaultCheck8" value="Other" onclick="disableSubjectField()">
            ...
            <fieldset>
                ...
                >You must be a junior or senior next academic year to be a peer
                    mentor.</small
                >
                <br />
            ...
            <br />
                ...
                <!-- Good Mentor -->
                <div class="form-group">
                    <label><span style="color:red">*</span> Why would you make a good mentor to first years and sophomores?</label>
                    <textarea class="form-control" name="reason" rows="3" required=""></textarea><br />
                </div>

                <!-- Requirements -->
                <div class="form-group">
                    <label><span style="color:red">*</span> What are the requirements to being a good mentor to someone who may have a different background than you?</label>
                    <textarea class="form-control" name="mentor_requirement" rows="3" required=""></textarea><br />
                </div>

                <!-- Challenge -->
                <div class="form-group">
                    <label><span style="color:red">*</span> Describe a time when you encountered a challenge in college, and how you dealt with it.</label>
                    <textarea class="form-control" name="challenge" rows="3" required=""></textarea><br />
                </div>

                <!-- First Generation Success -->
                <div class="form-group">
                    <label><span style="color:red">*</span> What does it take for a first generation college student to be successful?</label>
                    <textarea class="form-control" name="success" rows="3" required=""></textarea><br />
                </div>
