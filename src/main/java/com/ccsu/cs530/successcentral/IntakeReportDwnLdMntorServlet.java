...
@WebServlet(urlPatterns = "IntakeReportMentor")
public class IntakeReportDwnLdMntorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String fileName = "MentorIntakeReport.xlsx";
        ...
        try {
            ...
            excelfile = crud.excelReport_IntakeFormMentor(year);
